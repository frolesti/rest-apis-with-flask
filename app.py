...
def create_app(db_url=None):
    ...
    app.config["JWT_SECRET_KEY"] =  "308779935611231059432764917825205989290" #secrets.SystemRandom().getrandbits(128)
    jwt = JWTManager(app)
    ...
    def add_claims_to_jwt(identity):
        #Should check in the database if the user is an admin
        if identity == 1:
